...
const updateRules = [
  ...
  body("empresa")
    ...
    .trim()
    .isLength({ max: 100 })
    .withMessage("La empresa no puede superar 100 caracteres."),

  body("telefono")
    .optional({ nullable: true })
    .matches(/^\d{9,12}$/)
    .withMessage("El teléfono debe contener entre 9 y 12 dígitos."),
...
const validateChangePassword = [
  ...
  body("newPassword")
    ...
    .withMessage(
      "La nueva contraseña debe tener al menos 8 caracteres, incluyendo mayúsculas, minúsculas, números y caracteres especiales.",
    ),
];
